...
wf.find_element_by_xpath(".//*[@id='uploadExperienceForm']/div[1]/table/tbody/tr[1]/td[2]/input").send_keys(" ")
...
try:
    ...
    n=1
res.execute("SELECT eTitle,eContent FROM experience WHERE eTitle=' ' AND eContent='你好'")
mm=res.fetchone()
if mm==(' ','你好') :
    print("fail")
elif n==0:
